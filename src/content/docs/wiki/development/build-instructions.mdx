...
```console
git clone --recursive https://github.com/penguincre8te/PenguinLauncher.git
cd PenguinLauncher
```
...
```bash
nix build --print-build-logs '.#penguinlauncher-debug'
```
...
Flatpaks allow for you to quickly build Penguin and run it on any distribution
...
git clone --recursive https://github.com/penguinlauncher/PenguinLauncher

# Enter the Flatpak directory
cd PenguinLauncher/flatpak
...
flatpak run org.flatpak.Builder \
  ...
  --repo=repo \
  builddir \
  org.penguinlauncher.PenguinLauncher.yml
```
