...
In Penguin Launcher 9.0+, you can let the launcher handle Java automatically on Windows, macOS and Linux (not available in all packages) by enabling "Autodetect Java version" and "Auto-download Mojang Java" in:
...
Once you have **installed** Java, Penguin Launcher will be able to detect it during the first time set-up wizard.
...
The Penguin Launcher Flatpak already bundles Java.

#### NixOS

The Penguin Launcher NixOS package already bundles Java.
...
- Select this java binary on Penguin Launcher, and it should fix your issue!
